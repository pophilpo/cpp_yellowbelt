...
template <typename T> vector<T> Sqr(const vector<T> &vectr);
template <typename key, typename value>
map<key, value> Sqr(const map<key, value> &map_arg);
template <typename first, typename second>
pair<first, second> Sqr(const pair<first, second> &pair_arg);
template <typename T> T Sqr(T value) { return value * value; }
//-------------------------------------------------------------------------------------------------
template <typename T> std::vector<T> Sqr(const std::vector<T> &vectr) {
  std::vector<T> tmp;
